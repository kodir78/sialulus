            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Ubah Photo</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                    <div class="fileinput-new img-thumbnail" style="width: 200px; height: 150px;">
                                        <img src="{{ ($item->photo) ? url($item->photo) : '/assets/backend/adminlte30/dist/img/no_image.png' }}"  alt="...">
                                    </div>
                                    <div class="fileinput-preview fileinput-exists img-thumbnail" style="max-width: 200px; max-height: 150px;"></div>
                                    <div>
                                        <span class="btn btn-outline-secondary btn-file"><span class="fileinput-new">Select image</span>
                                        <span class="fileinput-exists">Change</span>
                                        <input type="file" class="@error('photo') is-invalid @enderror" name="photo" value="{{ old('photo') }}"></span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input {{$item->is_default == "1" ? "checked" : ""}} class="form-check-input @error('is_default') is-invalid @enderror" value="1" type="radio" name="is_default">
                                    <label class="form-check-label">Ya</label>
                                </div>
                                <div class="form-check">
                                    <input {{$item->is_default == "0" ? "checked" : ""}} class="form-check-input @error('is_default') is-invalid @enderror" value="0" type="radio" name="is_default">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('product-galleries.index') }}" class="btn btn-info">Batal</a>
                            </div>
                        </form>
                    </div>
